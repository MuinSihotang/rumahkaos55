<x-app-layout>
    <!-- Wrapper Utama Halaman Verifikasi Email -->
    <div class="bg-gray-50 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 selection:bg-black selection:text-white">
        <div class="max-w-md w-full space-y-8 bg-white p-10 border border-gray-200 text-center">
            ...
            <!-- Ilustrasi Ikon dan Teks Instruksi Dasar -->
            ...
            <!-- Menampilkan Umpan Balik Notifikasi Pengiriman Ulang Link -->
            @if (session('message'))
            ...
            <!-- Kelompok Formulir Aksi Pengguna -->
            <div class="mt-8 space-y-4">
                
                <!-- Eksekusi Pengiriman Ulang Tautan Verifikasi -->
                ...
                <!-- Eksekusi Terminasi Sesi Pengguna -->
