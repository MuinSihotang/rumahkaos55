                                            ...
                                            <div class="px-6 py-4">
                                                <ul class="divide-y divide-gray-100">
                                                    @foreach($order->items as $item)
                                                        <li class="py-4 flex">
                                                            <div class="h-24 w-20 flex-shrink-0 bg-gray-100 border border-gray-200 overflow-hidden">
                                                                @if($item->variant->product->image_path)
                                                                    <img src="{{ asset('storage/' . $item->variant->product->image_path) }}" class="h-full w-full object-cover">
                                                                @else
